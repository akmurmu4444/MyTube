...
import { Search, Sparkles, Video as VideoIcon } from 'lucide-react';
...
const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-6">
        {activeTab === 'discover' && (
          <TagBasedRecommendations onVideoSaved={handleVideoSaved} />
        )}
        
        {activeTab === 'search' && (
          <YouTubeSearch onVideoSaved={handleVideoSaved} />
        )}
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                        <span>
                          {video.watchCount > 0 ? `Watched ${video.watchCount}x` : 'Not watched'}
                        </span>
